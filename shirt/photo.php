  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register Brandwell</span>     
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<form action="photo.php" method="post" enctype="multipart/form-data" ><!-- form Starts -->
...
$get_email = "select * from pro where customer_email='$c_email'";
...
$insert = "insert into pro (customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_image,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$c_pass','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$customer_confirm_code')";
