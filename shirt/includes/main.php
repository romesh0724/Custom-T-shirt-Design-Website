                ...
                <div class="clearfix">
                  <div class="dropdown__half">
                    ...
                    <ul class="dropdown__items">
                      ...
                      <li class="dropdown__item">
                        <a href="https://threejs-t-shirt.vercel.app" class="dropdown__link">3D Design lab</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="http://localhost/shirt/admin_area/create.php" class="dropdown__link">Submit Your Design</a>
                      </li>
                    </ul>
                  </div>
              </div>
