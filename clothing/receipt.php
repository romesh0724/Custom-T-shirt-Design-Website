	...
	<table width="100%">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-right">Rs. <?php echo number_format($row['price'] * $row['qty'],2) ?></td>
			</tr>
			<?php endwhile; ?>
		</tbody>
	</table>
	...
	<table width="100%">
		<tbody>
			<tr>
				...
				<td class="text-right"><b>Rs. <?php echo number_format($total_amount,2) ?></b></td>
			</tr>
			...
			<tr>
				...
				<td class="text-right"><b>Rs. <?php echo number_format($amount_tendered,2) ?></b></td>
			</tr>
			<tr>
				<td><b>Change</b></td>
				<td class="text-right"><b>Rs. <?php echo number_format($amount_tendered - $total_amount,2) ?></b></td>
			</tr>
		<?php endif; ?>
