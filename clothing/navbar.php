...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<div class="mx-2 text-white">Manage Users</div>
				<a href="index.php?page=suppliers" class="nav-item nav-suppliers"><span class='icon-field'><i class="fa fa-list-alt "></i></span> Users</a>
				<a href="index.php?page=products" class="nav-item nav-products"><span class='icon-field'><i class="fa fa-tshirt "></i></span> T-shirts</a>
				<?php endif; ?>
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users "></i></span> Admins</a>
