						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Customer Name: <b><?php echo $row['name'] ?></b></p>
										<p><small>Customer Contact Number: <b><?php echo $row['contact'] ?></b></small></p>
										<p><small>Customer Address: <b><?php echo $row['address'] ?></b></small></p>
									</td>
