			...
			<form action="" id="manage-product">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">3D Design or Custom Design</label>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">T-shirt Code</th>
									<th class="text-center">T-shirt Info.</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>User Name: <b><?php echo $row['name'] ?></b></p>
										<p><small>Price: <b> Rs. <?php echo number_format($row['price'],2) ?></b></small></p>
