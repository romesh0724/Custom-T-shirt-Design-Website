                ...
                <table class="table table-bordered" id='report-list'>
                    <thead>
                        <tr>
                            ...
                            <th class="">Date</th>
                            <th class="">T-shirt Code</th>
                            <th class="">User Name</th>
                            <th class="">T-shirt Size</th>
                            <th class="">T-shirt Price</th>
                            <th class="">T-shirt QTY</th>
                            <th class="">Amount</th>
                        </tr>
                    </thead>
                    <tbody>
			          ...
			          <tr>
                        ...
                        <td>
                            <p class="text-right"> <b>Rs. <?php echo number_format($roww['price'],2) ?></b></p>
                        </td>
                        <td>
                            <p class="text-right"> <b><?php echo $roww['qty'] ?></b></p>
                        </td>
                        <td>
                            <p class="text-right"> <b>Rs. <?php echo number_format($roww['price']*$roww['qty'],2) ?></b></p>
                        </td>
                    </tr>
                    <?php 
                        endwhile;
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-right">Rs. <?php echo number_format($total,2) ?></th>
                        </tr>
                    </tfoot>
                </table>
                <hr>
